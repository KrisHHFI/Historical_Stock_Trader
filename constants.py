...
from utils.trading_algorithms.run_mock_keltner_channel_breakout_backtest import run_mock_keltner_channel_breakout_backtest
...
active_algorithm = run_mock_keltner_channel_breakout_backtest
