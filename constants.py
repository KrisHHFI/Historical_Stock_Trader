...
from utils.trading_algorithms.run_mock_statistical_arbitrage_backtest import run_mock_statistical_arbitrage_backtest
...
active_algorithm = run_mock_statistical_arbitrage_backtest
