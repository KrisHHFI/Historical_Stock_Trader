...
from utils.trading_algorithms.run_mock_momentum_trading_backtest import run_mock_momentum_trading_backtest
...
active_algorithm = run_mock_momentum_trading_backtest
